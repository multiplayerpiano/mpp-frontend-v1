...
c.setAttribute("id","midibridge-java");a="";a=-1===navigator.userAgent.toLowerCase().indexOf("chrome")?a+'<object tabindex="0" id="midibridge-applet" type="application/x-java-applet" height="1" width="1"><param name="codebase" value="java/" /><param name="archive" value="midiapplet.jar" /><param name="code" value="net.abumarkub.midi.applet.MidiApplet" /><param name="scriptable" value="true" /><param name="minJavaVersion" value="1.5" />Your browser needs the Java plugin to use the midibridge. You can download it <a href="https://web.archive.org/web/20150102175227/http://www.java.com/en/" target="blank" title="abumarkub midibridge download java" rel="abumarkub midibridge download java">here</a></object>':
